...
final int _kMaxDroppedSwipePageForwardAnimationTime = fastAnimation ? 500 : 800; // Milliseconds.

// The maximum time for a page to get reset to it's original position if the
// user releases a page mid swipe.
// const int _kMaxPageBackAnimationTime = 300; // Milliseconds.
final int _kMaxPageBackAnimationTime = fastAnimation ? 180 : 300; // Milliseconds.
...
final Duration _kModalPopupTransitionDuration = Duration(milliseconds: fastAnimation ? 200 : 335);
...
/// [PageRoute].
///
/// {@template flutter.cupertino.MycupertinoRouteTransitionMixin}
...
///  * [MyCupertinoPageRoute], which is a [PageRoute] that leverages this mixin.
mixin MyCupertinoRouteTransitionMixin<T> on PageRoute<T> {
  /// Builds the primary contents of the route.
  WidgetBuilder get builder;

  /// {@template flutter.cupertino.MycupertinoRouteTransitionMixin.title}
  ...
  void didChangePrevious(Route<dynamic> previousRoute) {
    final String previousTitleString =
        previousRoute is MyCupertinoRouteTransitionMixin ? previousRoute.title : null;
  ...
  Duration get transitionDuration => Duration(milliseconds: fastAnimation ? 250 : 400);
  ...
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    ...
    return nextRoute is MyCupertinoRouteTransitionMixin && !nextRoute.fullscreenDialog;
  }
  ...
  /// screen dialog, otherwise a [MyCupertinoPageTransition] is returned.
  ///
  ...
  /// See also:
  ///
  ///  * [MyCupertinoPageTransitionsBuilder], which uses this method to define a
  ...
  static Widget buildPageTransitions<T>(
    ...
    if (route.fullscreenDialog) {
      ...
      return MyCupertinoPageTransition(
        primaryRouteAnimation: animation,
        secondaryRouteAnimation: secondaryAnimation,
        linearTransition: linearTransition,
...
///
/// {@macro flutter.cupertino.MycupertinoRouteTransitionMixin}
///
...
/// See also:
///
///  * [MyCupertinoRouteTransitionMixin], for a mixin that provides iOS transition
///    for this modal route.
///  * [MaterialPageRoute], for an adaptive [PageRoute] that uses a
///    platform-appropriate transition.
///  * [MyCupertinoPageScaffold], for applications that have one page with a fixed
///    navigation bar on top.
///  * [CupertinoTabScaffold], for applications that have a tab bar at the
///    bottom with multiple pages.
///  * [MyCupertinoPage], for a [Page] version of this class.
class MyCupertinoPageRoute<T> extends PageRoute<T> with MyCupertinoRouteTransitionMixin<T> {
...
// A page-based version of MyCupertinoPageRoute.
//
// This route uses the builder from the page to build its content. This ensures
// the content is up to date after page updates.
class _MyPageBasedMyCupertinoPageRoute<T> extends PageRoute<T>
    with MyCupertinoRouteTransitionMixin<T> {
  _MyPageBasedMyCupertinoPageRoute({
    @required MyCupertinoPage<T> page,
  })  : assert(page != null),
        assert(opaque),
        super(settings: page);

  MyCupertinoPage<T> get _page => settings as MyCupertinoPage<T>;
...
/// See also:
///
///  * [MyCupertinoPageRoute], for a [PageRoute] version of this class.
class MyCupertinoPage<T> extends Page<T> {
  /// Creates a cupertino page.
  const MyCupertinoPage({
    @required this.builder,
    this.maintainState = true,
    this.title,
  ...
  /// {@macro flutter.cupertino.MycupertinoRouteTransitionMixin.title}
  final String title;
  ...
  Route<T> createRoute(BuildContext context) {
    return _MyPageBasedMyCupertinoPageRoute<T>(page: this);
  }
}
...
class _CupertinoBackGestureController<T> {
  ...
  void dragEnd(double velocity) {
    ...
    if (animateForward) {
      ...
      if (controller.isAnimating) {
        // Otherwise, use a custom popping animation duration and curve.
        // const Curve backAnimationCurve = Cubic(0.18, 1.0, 0.01, 1.0);
        const Curve backAnimationCurve = Cubic(0.18, 1.0, 0.3, 1.0);

        final int droppedPageBackAnimationTime = min(200,
            lerpDouble(0, _kMaxDroppedSwipePageForwardAnimationTime, controller.value).floor());

        // print("droppedPageBackAnimationTime is $droppedPageBackAnimationTime");
        controller.animateBack(0.0,
            duration: Duration(milliseconds: droppedPageBackAnimationTime),
            curve: backAnimationCurve);
    ...
    if (controller.isAnimating) {
      ...
      // curve of the page transition mid-flight since MyCupertinoPageTransition
